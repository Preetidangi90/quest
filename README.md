...
For Part 4 (AWS CloudFormation, AWS CDK, or Terraform), I did not have access to an AWS environment to build and test the pipeline, so I was unable to implement this section.”
